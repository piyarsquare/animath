...
| `#/counting-the-ways` | `CountingTheWays` | Why a Bessel function gives the conditional probabilities behind a Skellam (difference of two Poisson counts): the (gains, losses) lattice, the swept k-diagonal revealed as the Bessel sum, plus Sample and Fit modes |
